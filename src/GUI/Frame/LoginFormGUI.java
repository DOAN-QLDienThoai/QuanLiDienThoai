...
public class LoginFormGUI extends javax.swing.JFrame {
    ...
    public void setIconForJLabel() {
        jLabel6.setIcon(new FlatSVGIcon("./resources/icon/employee_1.svg", 0.095f));
        jLabel3.setIcon(new FlatSVGIcon("./resources/icon/loginicon.svg", 0.45f));
    }
    ...
    private void initComponents() {
        ...
        Dangnhap.setBackground(new java.awt.Color(204, 51, 255));
        Dangnhap.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        Dangnhap.setForeground(new java.awt.Color(0, 0, 204));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(Dangnhap, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39))
        );
    ...
    private void DangnhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DangnhapActionPerformed
        ...
        if(user.equals("") && pass.equals("")){
            jLabel5.setText("Enter full information please");
        }
        else {
            jLabel5.setText("Wrong account or password");
        }
