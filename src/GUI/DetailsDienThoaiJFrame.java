 ...
 * @author kiman
 */
public class DetailsDienThoaiJFrame extends javax.swing.JFrame {
    ...
    public DetailsDienThoaiJFrame(DienThoaiDTO dt) {
        initComponents();
    ...
    private void btn_view_cauHinhMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_view_cauHinhMouseClicked
        ...
        DetailsCauHinhJFrame detailsCauHinh=new DetailsCauHinhJFrame(maDT,listPBDTTemp);
        detailsCauHinh.setVisible(true);
        detailsCauHinh.setLocationRelativeTo(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailsDienThoaiJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailsDienThoaiJFrame(new DienThoaiDTO()).setVisible(true);
            }
        });
    }
