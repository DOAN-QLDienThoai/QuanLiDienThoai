...
public class PanelTrangChu extends javax.swing.JPanel {
    ...
    public void setIcon(){
        ...
        jlabel_ncc_nv.setIcon(new FlatSVGIcon("./resources/icon/persons.svg", 0.9f));
    ...
    private void initComponents() {
        ...
        pn1.setBackground(new java.awt.Color(255, 169, 77));
        ...
        pn3.setBackground(new java.awt.Color(255, 169, 77));
        ...
        pn2.setBackground(new java.awt.Color(255, 169, 77));
        ...
        pn4.setBackground(new java.awt.Color(255, 169, 77));
